...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Arjun Vashisht
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className='home__subtitle'>{`<h3> Web Developer </h3>`}</h3>
        <p className='home__description'>I'm creative Web Developer based in New Delhi and
        Highly passionate about programming, computer science and technology.</p>
